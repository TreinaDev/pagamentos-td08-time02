...
RSpec.describe Credit, type: :model do
  describe '#valid?' do
    context 'presence' do
      ...
      it 'inválido quando client_wallet estiver vazio' do
         should belong_to(:client_wallet) 
      end
  ...
  describe '#check_for_bnonus_conversion' do
    it 'adiciona saldo bônus caso haja conversão bônus' do
      ...
      client_wallet =create(:client_wallet, category: category)
      create(:credit, bonus_conversion: bonus_conversion, client_wallet: client_wallet)
